...
public class index{
    static String[] produtos = {"Feijão", "Café", "Arroz", "Snickers", "Farinha", "Coca-cola"};
    static double[] preços = {7.5, 30.75, 20, 5.5, 8, 15};
    ...
    public static void lista(){
        ...
        for(int i = 0; i < produtos.length; i ++){
            System.out.println("Produto: "+ produtos[i] + " - " + "Preço: " + preços[i]);
        }
    }
    ...
    public static void compras(){
        ...
        System.out.print("Digite a quantidade que desejas: ");
        int qntd = leitor.nextInt();

        String linha = "Item: ("+ opcao + ") " + produtos[opcao] + " - " + qntd + " Unidades.";
